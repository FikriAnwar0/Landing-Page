    ...
    menuToggle.addEventListener("click", function () {
        ...
        if (menuList.classList.contains("menu-active")) {
            ...
            setTimeout(() => {
                ...
                menuList.style.transition = "opacity 0.5s ease, transform 0.5s ease";
            }, 10);
        } else {
            menuList.style.opacity = "0";
            menuList.style.transform = "translateY(-20px)";
            ...
            }, 500); // Delay agar animasi selesai sebelum disembunyikan
        }
    });

    // Menutup menu ketika salah satu item diklik (di mobile)
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    menuToggle.addEventListener("click", function () {
        ...
        if (!menuList.classList.contains("hidden")) {
            menuList.classList.add("animate-slide-down");
        } else {
            menuList.classList.remove("animate-slide-down");
        }
    });
});
